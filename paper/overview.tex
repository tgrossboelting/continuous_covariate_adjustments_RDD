...
A coupling-agnostic set imposes no restriction beyond the primitive per-partial bounds.
Any strict subset of a coupling-agnostic set introduces a coupling --- an additional constraint linking the partial derivatives that is not implied by the marginal bounds alone.
